...
urlpatterns = [
    ...
    path("list_service_categories", ListServiceCategories.as_view(), name="list_service_categories"),
    path("list_service_items", ListServiceItems.as_view(), name="list_service_items"),
